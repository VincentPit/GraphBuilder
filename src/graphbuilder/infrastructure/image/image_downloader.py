"""
Image Downloader - Migrated from ImageEmbed/getPictures.py
...
Original File: ImageEmbed/getPictures.py
New Location: src/graphbuilder/infrastructure/image/image_downloader.py
"""
